...
public interface IDatasetService
{
    ...
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="dataTable"/> or <paramref name="jsonSchema"/> is null.</exception>
    ...
    /// Thrown if <paramref name="groupByField"/> is not groupable or <paramref name="aggregateField"/> is not aggregatable.
    /// </exception>
